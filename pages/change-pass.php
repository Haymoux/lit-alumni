<?php
   ...
   session_start();
     ...
     if (isset($_SESSION['change-pass-lvl'])){
...
<h2 class="heading-section">Welcome, <?php echo ($_SESSION['name']); ?></h2>
</div>
</div>
<div class="row justify-content-center">
    ...
    if (isset($_POST['submit'])){
        ...
        if ( empty($password) || empty($c_password) ){
            ...
            SET password='$password',
                fixed_password='$changed_placeholder' WHERE id= '$id' "
            );
            unset($_SESSION['change-pass-lvl']); //unset the all the verification status for security reasons
...
<input  type="password" class="form-control" placeholder="Confirm Password" minlength="8" maxlength="25" name="passwo2" required>
<label class="form-control-placeholder"></label>
