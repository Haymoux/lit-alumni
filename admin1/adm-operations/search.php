...
<?php
	...
	$result = 
        $conn->query
            ("SELECT * FROM members WHERE name LIKE '%".$showr."%' 
                OR (`email` LIKE '%".$showr."%') 
                    OR (`department` LIKE '%".$showr."%')  
                        OR (`phone_number` LIKE '%".$showr."%')  
                            LIMIT $start, $limit ");
...
<html>
    ...
    <div class="row">
        <div class="col-md-6">
        <h3>Search Results For "<?php echo $showr; ?>"</h3>
        </div>
...
//SEARCH REDIRECT CODE
 ...
 ?>
            ...
            <div class="container">
                <!-- <h1 class="text-center">testing www.peteramos.42web.io</h1> -->
